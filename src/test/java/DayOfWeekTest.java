...
class DayOfWeekTest {
     ...
     * 756 tests at all.
     *
     * @// TODO: 24-Jul-19 non valid day, month
     */
    @Test
    void nonValidArgsTests() {
        ...
        //month is october
        //day of New Year is monday
        checkException(1, Integer.MIN_VALUE, 10);
        checkException(1, Integer.MIN_VALUE + 1, 10);
        checkException(1, Integer.MIN_VALUE / 2, 10);
        checkException(1, -1, 10);
        checkException(1, 0, 10);
        checkException(1, MAX_DAY_OF_MONTH_31 + 1, 10);
        checkException(1, Integer.MAX_VALUE / 2, 10);
        checkException(1, Integer.MAX_VALUE - 1, 10);
        checkException(1, Integer.MAX_VALUE, 10);

        //day of New Year is tuesday
        checkException(2, Integer.MIN_VALUE, 10);
        checkException(2, Integer.MIN_VALUE + 1, 10);
        checkException(2, Integer.MIN_VALUE / 2, 10);
        checkException(2, -1, 10);
        checkException(2, 0, 10);
        checkException(2, MAX_DAY_OF_MONTH_31 + 1, 10);
        checkException(2, Integer.MAX_VALUE / 2, 10);
        checkException(2, Integer.MAX_VALUE - 1, 10);
        checkException(2, Integer.MAX_VALUE, 10);

        //day of New Year is wednesday
        checkException(3, Integer.MIN_VALUE, 10);
        checkException(3, Integer.MIN_VALUE + 1, 10);
        checkException(3, Integer.MIN_VALUE / 2, 10);
        checkException(3, -1, 10);
        checkException(3, 0, 10);
        checkException(3, MAX_DAY_OF_MONTH_31 + 1, 10);
        checkException(3, Integer.MAX_VALUE / 2, 10);
        checkException(3, Integer.MAX_VALUE - 1, 10);
        checkException(3, Integer.MAX_VALUE, 10);

        //day of New Year is thursday
        checkException(4, Integer.MIN_VALUE, 10);
        checkException(4, Integer.MIN_VALUE + 1, 10);
        checkException(4, Integer.MIN_VALUE / 2, 10);
        checkException(4, -1, 10);
        checkException(4, 0, 10);
        checkException(4, MAX_DAY_OF_MONTH_31 + 1, 10);
        checkException(4, Integer.MAX_VALUE / 2, 10);
        checkException(4, Integer.MAX_VALUE - 1, 10);
        checkException(4, Integer.MAX_VALUE, 10);

        //day of New Year is friday
        checkException(5, Integer.MIN_VALUE, 10);
        checkException(5, Integer.MIN_VALUE + 1, 10);
        checkException(5, Integer.MIN_VALUE / 2, 10);
        checkException(5, -1, 10);
        checkException(5, 0, 10);
        checkException(5, MAX_DAY_OF_MONTH_31 + 1, 10);
        checkException(5, Integer.MAX_VALUE / 2, 10);
        checkException(5, Integer.MAX_VALUE - 1, 10);
        checkException(5, Integer.MAX_VALUE, 10);

        //day of New Year is saturday
        checkException(6, Integer.MIN_VALUE, 10);
        checkException(6, Integer.MIN_VALUE + 1, 10);
        checkException(6, Integer.MIN_VALUE / 2, 10);
        checkException(6, -1, 10);
        checkException(6, 0, 10);
        checkException(6, MAX_DAY_OF_MONTH_31 + 1, 10);
        checkException(6, Integer.MAX_VALUE / 2, 10);
        checkException(6, Integer.MAX_VALUE - 1, 10);
        checkException(6, Integer.MAX_VALUE, 10);

        //day of New Year is sunday
        checkException(7, Integer.MIN_VALUE, 10);
        checkException(7, Integer.MIN_VALUE + 1, 10);
        checkException(7, Integer.MIN_VALUE / 2, 10);
        checkException(7, -1, 10);
        checkException(7, 0, 10);
        checkException(7, MAX_DAY_OF_MONTH_31 + 1, 10);
        checkException(7, Integer.MAX_VALUE / 2, 10);
        checkException(7, Integer.MAX_VALUE - 1, 10);
        checkException(7, Integer.MAX_VALUE, 10);
